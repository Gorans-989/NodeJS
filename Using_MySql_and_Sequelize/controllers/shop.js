...
exports.postCartDeleteProduct = (req, res, next) => {
    ...
    req.user.getCart()
        .then(cart => {
            return cart.getProducts({ where: { id: prodId } }); // built-in funkcii preku napravenite konekcii vo DB pomegu products, cart, cart-item ( getProducts, addProducts , getCart ....)
        })
        .then(products => {
